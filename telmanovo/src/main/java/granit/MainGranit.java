...
//        daoGranit.create(playerGranit15);
        ...
        List<PlayerGranit> granitList = daoGranit.readAll();
        for (int i = 0; i < granitList.size(); i++) {
            PlayerGranit playerGranit = granitList.get(i);
            System.out.println(playerGranit);
        }
